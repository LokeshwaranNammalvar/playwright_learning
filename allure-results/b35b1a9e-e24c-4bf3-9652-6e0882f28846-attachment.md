...
```
Error: ENOENT: no such file or directory, stat 'C:\Users\HP\OneDrive\Desktop\learning\"C:\Users\HP\Downloads\LOKESHWARAN N RESUME.pdf"'
```
...
> 29 |   await page.locator('[label="Select a File"]').setInputFiles('"C:\\Users\\HP\\Downloads\\LOKESHWARAN N RESUME.pdf"');
     |   ^ Error: ENOENT: no such file or directory, stat 'C:\Users\HP\OneDrive\Desktop\learning\"C:\Users\HP\Downloads\LOKESHWARAN N RESUME.pdf"'
  30 | })
```