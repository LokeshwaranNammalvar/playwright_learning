...
Call log:
  - waiting for locator('//h2[contains(@aria-label,"Galaxy S26 Ultra 5G")][1]')
    - locator resolved to <h2 class="a-size-medium a-spacing-none a-color-base a-text-normal" aria-label="Galaxy S26 Ultra 5G (Cobalt Violet, 12GB RAM, 256GB Storage) with Built-in Privacy Display, AI Phone, Photo Assist, Creative Studio, 200MP Camera, 5000mAh Battery and Snapdragon 8 Elite Gen 5">…</h2>
